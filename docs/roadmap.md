...
| Exact next action | Finish exact-head platform and package validation, file the separate dependent 1.11 PR, then pause. On explicit resumption, review/merge the release PRs in dependency order before starting 1.12. |
