...
| 1.11.0 | Workload routing + Training Supervisor | In progress on `feat/workload-jobs-1.11.0` | Durable jobs, independent placement, child execution, owner retention holds, restricted supervision and dashboard implemented; final regression/package/platform gates pending. See [release candidate notes](releases/1.11.0.md) |
...
| Active implementation branch/PR | `feat/workload-jobs-1.11.0`, based on `feat/unified-storage-1.10.0` / [PR #91](https://github.com/FactShin/TailCam/pull/91) |
...
| Implementation commit | Storage implementation `4dd9bdd89f2f6af8dce8467f6b7ce713efc7ebb3`; workload implementation and exact validation head are recorded in its separate PR |
