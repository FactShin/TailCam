  ...
  return (
    <div className="screen">
      ...
      <div className="panel ais-train">
        <div className="ais-train-ic"><IconSparkle size={20} /></div>
        <div className="ais-train-text">
          <b>Motion AI {ai?.enabled ? (ai.reachable && ai.model_present ? "· active" : "· needs setup") : "· off"}</b>
          <span>Label motion events with a local vision model. Set it up — pick and download a model right from the UI — in the AI section.</span>
        </div>
        <Button variant="primary" icon={<IconSparkle size={15} />} onClick={() => navigate("/ai")}>
          Open AI setup →
        </Button>
      </div>
